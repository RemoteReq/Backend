  ...
  try {
    ...
    if(getData != null){
      ...
      var mailOptions = {
        ...
        html: '<p>Please click this link to reset your password <a target="_blank"  href="'+process.env.EMPLOYER_BASE_URL+'employerResetPassword?resetToken='+resetToken+'">'+process.env.EMPLOYER_BASE_URL+'employerResetPassword?resetToken='+resetToken+'</a></p><p><b>**Note: </b>Link validity only for 15 minutes</p>',
      };
